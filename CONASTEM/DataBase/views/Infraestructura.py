...
def Sostenibilidad_new(request):
    ...
    return render(request, 'Form_Subcriterio.html', {'form_new': form_new , 'titulo':'1700-SOSTENIBILIDAD'})
...
def Uso_de_info_new(request):
    ...
    return render(request, 'Form_Subcriterio.html', {'form_new': form_new , 'titulo':'1700-USO DE INFORMACION'})